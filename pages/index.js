        ...
        {img &&
          <div style={previewFlex}>
            <div style={{ margin: '0 auto' }}>
              ...
              {img && (
                <div>
                  <Image src={img} width={250} height={250} alt="local preview" style={previewStyle} />
                </div>
              )
              }
            </div>
            <div style={{ margin: '0 auto' }}>
              ...
              {URI && (
                <>
                  <Image loader={imageLoader} src={URI} width={250} height={250} style={previewStyle} alt='Arweave image' />
                  <a href={URI} target="_blank" rel="noreferrer noopener">{URI}</a>
                </>
              )
              }
            </div>
